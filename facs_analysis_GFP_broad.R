...
dir="/Users/joncchen/Dropbox (MIT)/Collins Lab: RNA-ligand screen/Raw Flow Files/2023-02-21/Exp_20230221_1/GFP/"
...
# g.gfp <- rectangleGate(filterId="GFP_pos",GFP=c(5000,1e6))
# # check gate
...
data_stats <- cbind(data_stats, Total_counts, Live_percent, Singlets, GFP_pos, GFP_percent)

data_stats

#write csv (open in excel) file with median stats
write.csv(data_stats,file=paste(dir,"hist_median_stats.csv",sep=""))
